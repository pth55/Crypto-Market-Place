  ...
  return (
    <div className='py-0 px-[10px] pb-[100px]'>
      ...
      <div className='flex max-w-[600px] my-[80px] mx-auto flex-col items-center text-center gap-[30px]'>
        ...
        <form onSubmit={searchHandler} className='flex p-[8px] w-[80%] bg-white rounded-[5px] text-[20px] justify-between items-center gap-[10px]'>
          <input 
            className='flex-1 text-[16px] outline-none border-none pl-[10px] text-[#da6088]'
            value={input} 
            type="text" 
